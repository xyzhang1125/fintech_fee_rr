...
# Function that tests whether final adoption rates increase with y.
...
function check_mono_y(;
    ...
    for y = LinRange(yh, yl, 101) # Loop over y in a reverse order.
        cr = adoption_rate(;
...
writedlm(
    joinpath(fig_dir, "data_barplot_final_adoption_y.csv"),
    res_d
)
